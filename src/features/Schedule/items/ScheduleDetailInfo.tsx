  ...
  return (
    <div className="w-full bg-grayWhite rounded-lg p-6">
      <div className="space-y-4">
        ...
        <div className="flex items-center flex-1">
          ...
          <div className="flex-1 relative">
            <FilterSelectBox
              ...
              onChange={(value) =>
                handleInputChange('acctNm', mockDataAcctNm.find((option) => option.codeId === value)?.dtlNm || '원예진')
              }
        ...
        {/* 시간 */}
        <div className="flex items-center flex-1">
          <label className="text-xl text-black font-bold w-28">시간</label>
          <div className="flex-1 relative">
            <FilterSelectBox
              id="time"
              label=""
              ...
              onChange={(value) =>
                handleInputChange(
                  'time',
                  mockDataTime.find((option) => option.codeId === value)?.dtlNm || '09:00 ~ 09:50'
                )
              }
        ...
        {/* 고정수업 여부 */}
        <div className="flex items-center flex-1">
          <label className="text-xl text-black font-bold w-28">고정수업 여부</label>
            ...
            <label className="flex items-center gap-5px cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleInputChange(
                    'fixedClass',
                    mockDataFixedClass.find((option) => option.dtlNm === e.target.value)?.dtlNm || 'Y'
                  )
                }
              />
            ...
            <label className="flex items-center gap-5px cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleInputChange(
                    'fixedClass',
                    mockDataFixedClass.find((option) => option.dtlNm === e.target.value)?.dtlNm || 'N'
                  )
                }
              />
        ...
        {/* 수업 상태 */}
        <div className="flex items-center flex-1">
          <label className="text-xl text-black font-bold w-28">수업 상태</label>
          <div className="flex-1 flex items-center gap-20px ml-20px">
            <label className="flex items-center gap-5px cursor-pointer">
              <input
                type="radio"
                ...
                onChange={(e) =>
                  handleInputChange(
                    'classStatus',
                    mockDataClassStatus.find((option) => option.dtlNm === e.target.value)?.dtlNm || 'SCH'
                  )
                }
              />
            ...
            <label className="flex items-center gap-5px cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleInputChange(
                    'classStatus',
                    mockDataClassStatus.find((option) => option.dtlNm === e.target.value)?.dtlNm || 'COM'
                  )
                }
              />
            ...
            <label className="flex items-center gap-5px cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  handleInputChange(
                    'classStatus',
                    mockDataClassStatus.find((option) => option.dtlNm === e.target.value)?.dtlNm || 'NOS'
                  )
                }
              />

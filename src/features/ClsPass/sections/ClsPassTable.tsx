...
export default function ClsPassTable({ data, isLoading, onDetailView }: ClsPassProps) {
  ...
  return (
    <div className="h-full max-h-[calc(100vh-340px)] flex flex-col overflow-hidden min-h-0">
      ...
      {/* 하단 합계 바 */}
      <div className="flex-shrink-0 overflow-y-auto mr-20px min-h-0 mx-20px mt-30px rounded-default">
        <div className="grid grid-cols-6 items-center">
          <div className="col-span-6 bg-whiteGray text-black grid grid-cols-6">
            <div className="px-3 py-2 border-r border-lightGray">

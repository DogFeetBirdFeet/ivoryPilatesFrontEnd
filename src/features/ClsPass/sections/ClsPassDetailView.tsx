...
export default function ClsPassDetailView(props: IPropsAuthority) {
    ...
    return (
        <div className="w-full h-full flex flex-col">
            {/* 헤더 섹션 - 유저 정보와 버튼 */}
            <section
                className="flex justify-between items-center py-15px border-b border-grayD9 border-b-[1.5px] mb-25px">
                {/* 왼쪽: 유저 정보 */}
                {props.userNm !== '' && (
                    <div className="flex items-center gap-10px">
                        <img src={iconIvo} className="w-[80px] h-[80px]" alt="User Icon"/>
            ...
            {/* 사용자 데이터 필드들 */}
            <section className="flex justify-between flex-wrap mb-20px h-[100px]">
                <div className="flex flex-col justify-between w-[450px] bg-purpleLight2 p-15px rounded-default">
                    <label className="text-xl font-bold text-ppt">연락처</label>
                    <p className="text-2xl font-bold text-black">{mockUserData.contact}</p>
                </div>
                <div className="flex flex-col justify-between w-[450px] bg-purpleLight2 p-15px rounded-default">
                    <label className="text-xl font-bold text-ppt">생년월일</label>
                    <p className="text-2xl font-bold text-black">{mockUserData.birthDate}</p>
                </div>
                <div className="flex flex-col justify-between w-[450px] bg-purpleLight2 p-15px rounded-default">
                    <label className="text-xl font-bold text-ppt">성별</label>
                    <p className="text-2xl font-bold text-black">{mockUserData.gender}</p>
                </div>
                <div className="flex flex-col justify-between w-[450px] bg-purpleLight2 p-15px rounded-default">
                    <label className="text-xl font-bold text-ppt">회원구분</label>

    ...
    return (
        <section className="mb-[15px]">
            <div className="flex items-center gap-[5px] mb-[10px]">
                <h3 className="text-[26px] font-bold text-ppm py-[5px] my-[5px]">수강권 정보</h3>
            ...
            <div className="p-[20px] bg-white rounded-md">
                <div className="flex items-center py-[5px] my-[5px]">
                    <span className="text-xl font-bold text-ppm w-[200px]">개시 일자</span>
                    {currentUseAge === 5 && (
                        <InputDate
                            id="staDtm"
                ...
                <div className="flex items-center py-5px my-5px">
                    <span className="text-xl font-bold text-ppm w-[200px]">총 회차</span>
                    {currentUseAge !== 5 && (
                        <>
                            {editable && authority === 2 && !data.refundYn && (
                                <InputNumber

    ...
    return (
        <section className="mb-[15px]">
            <div className="flex items-center gap-[5px] mb-[10px]">
                <h3 className="text-[26px] font-bold text-ppm py-[5px] my-[5px]">상품정보</h3>
            ...
            <div className="p-20px bg-white rounded-md">
                ...
                <div className="flex items-center py-[5px] my-[5px]">
                    ...
                    <span className="text-xl ml-[20px]">{data.price.toLocaleString()}</span>
                </div>
                <div className="flex items-center py-[5px] my-[5px]">
                    <span className="text-xl font-bold text-ppm w-[200px]">기본 할인 금액</span>
                    <span className="text-xl ml-[20px]">{data.discountAmtPkg.toLocaleString()}</span>
                </div>
                <div className="flex items-center py-[5px] my-[5px]">

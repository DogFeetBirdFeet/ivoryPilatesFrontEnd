      ...
      <section>
        ...
        <div className="p-20px bg-ppLight rounded-md">
          ...
          <div className="flex items-center py-5px my-5px">
            ...
            {currentUseAge !== 5 && <span className="text-2xl ml-20px">{data.payDate}</span>}
          </div>
          <div className="flex items-center py-5px my-5px">
            ...
            {currentUseAge !== 5 && <span className="text-2xl ml-20px">{data.payMethod}</span>}
          </div>
          <div className="flex items-center py-5px my-5px">
            ...
            {currentUseAge !== 5 && <span className="text-2xl ml-20px">{data.instMm}개월</span>}
          </div>
          <div className="flex items-center py-5px my-5px">
            {currentUseAge !== 5 && (
              <>
          ...
          <div className="flex items-center py-5px my-5px">
            ...
            {!editable && <span className="text-2xl ml-20px">{data.remark}</span>}
          </div>
        </div>
      </section>
      {/* 만료 + 환불 O */}

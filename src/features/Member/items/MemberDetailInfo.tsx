...
import type { IMember, IMemberCos, IMemberDefaultInfo } from '../types';
...
export default function MemberDetailInfo({
  ...
  editMode: boolean;
  data: IMemberDefaultInfo;
  setData: Dispatch<SetStateAction<IMemberCos>>;
}) {
  // 공통 핸들러 함수
    ...
    <section className="w-[1200px]">
      ...
      <div className="flex justify-between gap-100px p-20px bg-white rounded-default">
        ...
        <div className="w-[250px]">
          ...
          <BodyCheckImg
            image={data.bodyImg}
            onImageChange={(newVal) => handleChange('bodyImg', newVal)}
            editMode={editMode}
          />
        </div>
      </div>

  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <section className="flex p-20px gap-30px font-medium bg-ppLight rounded-md mt-10px flex-shrink-0 mx-20px">
      ...
      {/* 필터 */}
      <section className="flex justify-end py-10px gap-10px font-medium text-xl text-black rounded-default mt-10px flex-shrink-0 mx-20px">
        <FilterSelectBox
          id="use_yn"
          label="상품 사용 여부"
          options={YN ?? []}
